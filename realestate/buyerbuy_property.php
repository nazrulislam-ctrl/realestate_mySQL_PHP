...
if(isset($_POST['submit'])){
	...
	$query="INSERT INTO property (property_id,property_name,price,property_type,district,post_office,police_station,road_no,availability, description, image ) VALUES ('$a','$b','$c','$d','$e','$f','$g','$h', '$i','$j', '$k')";
  ...
  <fieldset>
    ...
    <div class="form-group">
      <div class="col-lg-10 col-lg-offset-2">
        ...
        <li><a href="buyer_info.php" class="text-light">Go Back </a></li>
      </ul>
      </div>
    </div>
  </fieldset>
